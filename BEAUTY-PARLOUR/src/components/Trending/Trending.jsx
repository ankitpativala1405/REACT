...
const Trending = () => {
    return (
        <>
            <div className='py-10 flex container mx-auto px-30'>
                <div className="container">
                    <div className='flex gap-x-[50px]'>
                        <div className='max-w-[45%]'>
                            <h2 className='text-[2rem] font-black'>What’s Trending?</h2>
                            ...
                            <Box sx={{ '& button': { m: 1 } }} className='mt-5'>
                                <div>
                                    <Button variant="contained" size="large" sx={{
                                        width: '150px', backgroundColor: '#EB212E', fontWeight: 700, transition: 'transform 0.5s',
                                        '&:hover': {
                                            transform: 'scale(1.1)',
